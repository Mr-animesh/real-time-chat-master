...
export default function SignupPage() {
    ...
    const validateForm = () => {
        ...
        if(formData.password.length < 6) return toast.error("Password must be atleat of 6 characters")
        return true;
    }
    ...
    return (
      <div className="min-h-full bg-base-100 grid lg:grid-cols-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 ">
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="absolute inset-y-0 right-0 pr-3 foex items-center"
